...
import com.lytear.springTest.Dlesson05.model.Member;
...
public class DLesson05Controller {
	...
	@GetMapping("/Dtest02")
	public String Dtest02(Model model) {
		...
		return "lesson05/Dtest02";
	}
	
	@GetMapping("/Dtest03")
	public String Dtest03(Model model) {
	...
	@GetMapping("/Dtest04")
	public String Dtest04(Model model) {
