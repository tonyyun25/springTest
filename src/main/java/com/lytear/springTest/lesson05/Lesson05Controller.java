...
import com.lytear.springTest.lesson05.model.Member;
...
public class Lesson05Controller {
	...
	public String test03(Model model) {
		...
		model.addAttribute("membership", membership);// 앞: 키 뒤: 변수이름. 달라도 됨
	...
	public String test04(Model model) {
		...
		// 위에서 앞의 "candidates"와  뒤 candidates 변수명과는 관계 없음
		// 뒤 candidates는 List 안의 값을 의미하며 중요한 것은 "candidates"만 List명과 일치
	...
	public String test06(Model model
		...
		/*모델어트리뷰트는 파라미터를 받을때 사용하는 거에요 지금 사용하는 형태는 아닙니다 ^^
