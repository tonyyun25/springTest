...
<title>통나무 펜션</title>
	<!-- 
	datapicker 팝업 안 뜬 원인 : 2. 스크립트와 css 는 위치에 따라서 다르게 작동할수 잇어요. 해당 스크립트와 css 를 불러오는 내용을 부트스트랩 밑에 쪽에 추가해보세요.
	결론적으로 css 불러오는 내용은 맨 위에 두고 datepicker(스크립트)만 Bootstrap CDN 아래에 옮기면 실행 잘 됨
